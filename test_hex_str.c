...
/*   Updated: 2019/07/12 17:10:24 by ubartemi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_add_uhex_str2(char **result, char *cpy_res, char *str, size_t len,  char sym, t_prinlist *lst)
{
	char	*tmp;
...
void	ft_add_uhex_str(char **result, unsigned long long arg, t_prinlist *lst, char sym)
{
	...
	ft_add_uhex_str2(result, cpy_res, str, len, sym, lst);
}

void ft_add_hex_str_2(char **result, char *cpy_res, char *str, size_t len,  char sym, t_prinlist *lst)
{
    char *tmp;
...
void ft_add_hex_str(char **result, long long int arg, t_prinlist *lst, char sym)
{
    ...
    ft_add_hex_str_2(result, cpy_res, str, len, sym, lst);
}
